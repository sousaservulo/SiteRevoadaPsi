...
if (isset($_POST['btnSend'])) {
   ...
   // $assunto = $_POST["assunto"];
    ...
    if ((!empty($nome)) && (!empty($email)) && (!empty($telefone)) && (!empty($assunto)) && (!empty($mensagem))) {
        ...
        $email_remetente = "revoadapsi@gmail.com"; // deve ser uma conta de email do seu dominio 
        $email_destinatario = "revoadapsi@gmail.com"; // email que receberá as mensagens
